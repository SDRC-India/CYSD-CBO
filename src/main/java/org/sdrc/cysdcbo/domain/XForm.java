...
public class XForm implements Serializable{
    ...
    public String getOtherBlockXpath() {
		return otherBlockXpath;
	}

	public void setOtherBlockXpath(String otherBlockXpath) {
		this.otherBlockXpath = otherBlockXpath;
	}

	public String getDistrictXpath() {
		return districtXpath;
	}

	public void setDistrictXpath(String districtXpath) {
		this.districtXpath = districtXpath;
	}
	...
	@Column(name = "otherBlockXpath")
	private String otherBlockXpath;
	
	@Column(name = "districtXpath")
	private String districtXpath;
