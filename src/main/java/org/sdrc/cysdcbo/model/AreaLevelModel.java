...
public class AreaLevelModel {
	...
	private Integer areaLevelParentId;
	...
	public Integer getAreaLevelParentId() {
		return areaLevelParentId;
	}
	public void setAreaLevelParentId(Integer areaLevelParentId) {
		this.areaLevelParentId = areaLevelParentId;
	}
