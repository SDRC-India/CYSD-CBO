...
<head>
<title>CYSD-CBO-Monitoring| Privacy Policy</title>
...
<body>
	...
	<div class="container-fluid">
		<div class="col-md-12 col-sm-12 col-xs-12 ">
			...
			<p>This privacy policy sets out how CYDSCBO
						uses and protects any information that you give while you use this
						website.</p>
					<p>CYDSCBO is committed to ensuring that your
					...
					<p >CYDSCBO may change this policy from time to
					...
					<p >While using our Site, we may ask you to
					...
					<p >Except as otherwise stated in this privacy
					...
					<h3 >Security</h3>
					<p >We are committed to ensuring that your
					...
					<p >The site may use cookies to enhance users'
					...
					<p >At many places in this website, you will
						find links to other websites/ portals. These links have been
						placed for your convenience. CYDSCBO has no control over the
					...
					<p >This website and its content is copyright
						of CYDSCBO - © CYDSCBO 2018. All rights reserved. Any
					...
					<p >However, the permission to reproduce any
